...
def fakeEmail():
  ...
  if chon == '2':
    ...
    for fake in range(so_luong):
      ...
      print (" [" + str(n) + "] => |NguyenHuuKien|     " + mail)
...
def checkhotmail():
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m=> |\033[1;37mNguyenHuuKien\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m=> |\033[1;37mNguyenHuuKien033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def logo():
 ...
 ____  _____  ____  \033[1;36m ____  ___  ____   
|_   \|_   _||_   ||   _|\033[1;34m |_  ||_  _|  
  |   \ | |    | |__| |    |\033[1;31m  |_/ /    
  | |\ \| |    |  __  |    |\033[1;32m  __'.    
 _| |_\   |_  _| |  | |_ \033[1;35m _| |  \ \_  
|_____|\____||____|\033[1;35m |____||____||____| 


                  \033[1;36m- Tool By : Kien Official 
                  \033[1;31m- Donate : Mb Bank: 0961718588
                  \033[1;32m- Zalo : 0961718588 
